...
let s:sBuildPath = $INDEXER_PROJECT_ROOT.'/../build-bterm-Desktop_Qt_5_5_0_GCC_32bit-Debug'
if !isdirectory(s:sBuildPath)
   let s:sBuildPath = $INDEXER_PROJECT_ROOT.'/../build-bterm-Desktop_Qt_5_4_1_GCC_32bit-Debug'
endif
